module github.com/reecepbcups/sei-decode

// https://github.com/sei-protocol/sei-chain/blob/master/go.mod
...
replace (
	...
	github.com/cosmos/cosmos-sdk => github.com/sei-protocol/sei-cosmos v0.2.19
